...
public class NewsDetailActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		settings.setBlockNetworkImage(false);//解决图片不显示
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {//解决图片不显示
				settings.setMixedContentMode(WebSettings.MIXED_CONTENT_ALWAYS_ALLOW);//解决图片不显示
			}
		...
		mWebView.setWebViewClient(new WebViewClient() {
			...
			public void onPageFinished(WebView view, String url) {
				...
				view.loadUrl("javascript:function setTop(){document.querySelector('.openBox-shareEntry').style.display=\"none\";}setTop();");
	...
	private void showShare() {
		...
		oks.setTitle("ss"/*getString(R.string.share)*/);
